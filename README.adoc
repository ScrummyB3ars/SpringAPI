...
This guide walks you through the process of creating a "api world" link:/understanding/REST[RESTful web service] with Spring.
...
`src/main/java/api/Greeting.java`
[source,java]
----
include::complete/src/main/java/api/Greeting.java[]
----
...
`src/main/java/api/GreetingController.java`
[source,java]
----
include::complete/src/main/java/api/GreetingController.java[]
----
...
`src/main/java/api/Application.java`
[source,java]
----
include::complete/src/main/java/api/Application.java[]
----
